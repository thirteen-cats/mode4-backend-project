...
* Request
  * Method: GET
  * URL:  /current      -- NOT  /users/:userId -- as userId will be stored in the session, there is no need to insert a userId
  * Body: none
...
* Request
  * Method: POST
  * URL:  /groups/:groupId/images                            -- /images/groups/:groupId
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: /groups/:groupId/images/:imageId   -- (OR /group-images/:imageId)
  * Body: none
